...
- Ask 2-3 specific questions about the text's main problems, including logic, clarity, or grammar.
...
Example for content:
For "i am a good man", you can ask: "你提到自己是‘a good man’，能举一个具体的例子来展示这一点吗？"`,
